...
@section('page-title', 'Buat Access Code')
@section('page-subtitle', 'Kode ini wajib dimasukkan user sebelum membuat userbot')

@section('content')
<form method="POST" action="{{ route('telegram-access-codes.store') }}" class="rounded-xl border border-white/10 bg-white/[0.05] p-6">
    @csrf
